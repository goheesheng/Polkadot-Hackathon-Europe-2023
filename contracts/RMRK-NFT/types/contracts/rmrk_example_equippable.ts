...
import ABI from '../../artifacts/rmrk_example_equippable.json';
import QueryMethods from '../query/rmrk_example_equippable';
import BuildExtrinsicMethods from '../build-extrinsic/rmrk_example_equippable';
import TxSignAndSendMethods from '../tx-sign-and-send/rmrk_example_equippable';
import MixedMethods from '../mixed-methods/rmrk_example_equippable';
import EventsClass from '../events/rmrk_example_equippable';
