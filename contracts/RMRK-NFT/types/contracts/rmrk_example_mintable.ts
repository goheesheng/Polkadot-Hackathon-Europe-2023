...
import ABI from '../../artifacts/rmrk_example_mintable.json';
import QueryMethods from '../query/rmrk_example_mintable';
import BuildExtrinsicMethods from '../build-extrinsic/rmrk_example_mintable';
import TxSignAndSendMethods from '../tx-sign-and-send/rmrk_example_mintable';
import MixedMethods from '../mixed-methods/rmrk_example_mintable';
import EventsClass from '../events/rmrk_example_mintable';
