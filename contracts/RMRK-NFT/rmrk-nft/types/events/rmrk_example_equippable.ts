import type * as EventTypes from '../event-types/rmrk_example_equippable';
...
export default class EventsClass {
	...
	public subscribeOnTransferEvent(callback : (event : EventTypes.Transfer) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('Transfer', 'rmrk_example_equippable')) as EventTypes.Transfer);
		};
	...
	public subscribeOnApprovalEvent(callback : (event : EventTypes.Approval) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('Approval', 'rmrk_example_equippable')) as EventTypes.Approval);
		};
	...
	public subscribeOnChildAddedEvent(callback : (event : EventTypes.ChildAdded) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('ChildAdded', 'rmrk_example_equippable')) as EventTypes.ChildAdded);
		};
	...
	public subscribeOnChildAcceptedEvent(callback : (event : EventTypes.ChildAccepted) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('ChildAccepted', 'rmrk_example_equippable')) as EventTypes.ChildAccepted);
		};
	...
	public subscribeOnChildRemovedEvent(callback : (event : EventTypes.ChildRemoved) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('ChildRemoved', 'rmrk_example_equippable')) as EventTypes.ChildRemoved);
		};
	...
	public subscribeOnChildRejectedEvent(callback : (event : EventTypes.ChildRejected) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('ChildRejected', 'rmrk_example_equippable')) as EventTypes.ChildRejected);
		};
	...
	public subscribeOnAssetSetEvent(callback : (event : EventTypes.AssetSet) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('AssetSet', 'rmrk_example_equippable')) as EventTypes.AssetSet);
		};
	...
	public subscribeOnAssetAddedToTokenEvent(callback : (event : EventTypes.AssetAddedToToken) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('AssetAddedToToken', 'rmrk_example_equippable')) as EventTypes.AssetAddedToToken);
		};
	...
	public subscribeOnAssetAcceptedEvent(callback : (event : EventTypes.AssetAccepted) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('AssetAccepted', 'rmrk_example_equippable')) as EventTypes.AssetAccepted);
		};
	...
	public subscribeOnAssetRejectedEvent(callback : (event : EventTypes.AssetRejected) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('AssetRejected', 'rmrk_example_equippable')) as EventTypes.AssetRejected);
		};
	...
	public subscribeOnAssetRemovedEvent(callback : (event : EventTypes.AssetRemoved) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('AssetRemoved', 'rmrk_example_equippable')) as EventTypes.AssetRemoved);
		};
	...
	public subscribeOnAssetPrioritySetEvent(callback : (event : EventTypes.AssetPrioritySet) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('AssetPrioritySet', 'rmrk_example_equippable')) as EventTypes.AssetPrioritySet);
		};
	...
	public subscribeOnAssetEquippedEvent(callback : (event : EventTypes.AssetEquipped) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('AssetEquipped', 'rmrk_example_equippable')) as EventTypes.AssetEquipped);
		};
	...
	public subscribeOnAssetUnEquippedEvent(callback : (event : EventTypes.AssetUnEquipped) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('AssetUnEquipped', 'rmrk_example_equippable')) as EventTypes.AssetUnEquipped);
		};
	...
	public subscribeOnParentEquippableGroupSetEvent(callback : (event : EventTypes.ParentEquippableGroupSet) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('ParentEquippableGroupSet', 'rmrk_example_equippable')) as EventTypes.ParentEquippableGroupSet);
		};
