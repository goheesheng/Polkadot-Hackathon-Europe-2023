...
declare type Versions = typeof enumVersions[number] | 'V0';
declare type Converter = (registry: Registry, vx: any) => ContractMetadataLatest;
export declare function v4ToLatest(registry: Registry, v4: ContractMetadataV4): ContractMetadataLatest;
