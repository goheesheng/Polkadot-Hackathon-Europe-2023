...
import type { ChainProperties, DispatchErrorModule, DispatchErrorModuleU8, DispatchErrorModuleU8a, Hash, MetadataLatest, SiLookupTypeId } from '@polkadot/types/interfaces/types';
import type { CallFunction, CodecHasher, DetectCodec, RegisteredTypes, Registry, RegistryError, RegistryTypes } from '@polkadot/types/types';
import { GenericEventData } from '@polkadot/types/generic/Event';
import { Metadata } from '@polkadot/types/metadata/Metadata';
import { PortableRegistry } from '@polkadot/types/metadata/PortableRegistry';
